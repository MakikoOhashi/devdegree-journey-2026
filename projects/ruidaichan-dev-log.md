...
- AppleからRuidaichanレビュー返答あり（課金有無の確認）
- 現状課金はない旨を返答済み
- 将来の無料制限導入時は、「現時点で課金なし」を審査回答で明示する運用メモを追加
...
- AIEO 実験の一環として、Ruidaichan iOS アプリの説明文を改善（1日1改善を開始）

## 2026-05-08

- AIEO 継続（1日1改善 / Notion に記録）
- Ruidaichan iOS: 説明文を再改善（改善後も提案されず → 追加で調整）

# LSAT Logic Games 学習記録

## 目的
- **主目的:** CoderPad論理テスト対策（Devdegree再挑戦）
- **副次効果:** DET Reading/論理問題の基礎力強化

## 戦略

### Phase 1: 新規問題を最大限解く（2-4月）
- 同じ問題の繰り返しより、**多様な問題パターンに触れる**
- 論理テストは「パターン認識」が命
- 目標: 50-100問（可能な限り）

### Phase 2: 弱点パターンの反復（5-6月）
- Phase 1で間違えた/時間かかった問題のみ再挑戦
- パターン別に弱点整理
...
#### 公式・準公式
- [ ] [Khan Academy LSAT](https://www.khanacademy.org/prep/lsat) - 無料コース確認
- [ ] [LSAC Sample Questions](https://www.lsac.org/lsat/prep) - 公式サンプル
- [ ] [7Sage LSAT Free](https://7sage.com/lsat-logic-games/) - 一部無料

#### コミュニティ・教材
- [ ] Reddit r/LSAT - 共有問題
- [ ] YouTube LSAT channels - 解説動画付き問題
- [ ] Scribd/Archive.org - 過去問PDF
...
### 2026-02-24
- [BrainBashers Puzzle ZYZN](https://www.brainbashers.com/puzzle/zyzn) を1問完了
- 結果: 正解

### 2026-02-25
- [BrainBashers Puzzle ZIXB](https://www.brainbashers.com/puzzle/zixb) を1問完了
- 結果: 正解
...
### 2026-03-06
- [BrainBashers Puzzle ZMKA](https://www.brainbashers.com/puzzle/zmka) を1問完了
- 結果: 正解
...
| Ordering | 1 | - | 記載予定 |
| Grouping | 1 | - | 記載予定 |
| In-Out Grouping | 1 | - | 記載予定 |
| Hybrid | 1 | - | 記載予定 |
| Miscellaneous | 1 | - | 記載予定 |
...
### なぜ繰り返しより新規優先？
1. **パターン認識が重要** - 同じ問題5回 < 異なる問題5つ
2. **CoderPadは初見問題** - 慣れた問題では対策にならない
3. **時間効率** - 新鮮な刺激 > 記憶の強化
...
### 2026-03-25
- https://www.brainbashers.com/puzzle/zvxi
- 初見では解き方がわからなかった
- 学び:
...
### 2026-03-26
- https://www.brainbashers.com/puzzle/zror
- 不正解
- 学び:
  - 人に割り当てる前に、条件から「あり得る4つの色ペア」を先に確定する
  - 今回は `red+green`, `green+blue`, `yellow+blue`, `yellow+red` の4ペアに固定できた
